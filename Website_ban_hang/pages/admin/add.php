...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error)) {
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO tbl_sanpham (tensanpham, giasanpham, soluongsanpham, mota, id_danhmuc, hinh_anh) VALUES (?, ?, ?, ?, ?, ?)");
            $stmt->bind_param("sdisis", $name, $price, $quantity, $description, $categoryId, $imagePath);
            
            if ($stmt->execute()) {
                header("Location: manage_product.php?success=added");
                exit();
            } else {
...
<head>
    ...
    <title>LE.GICARFT | Thêm sản phẩm</title>
            ...
            <div class="col-md-10 p-4">
                ...
                <div class="form-container">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3><i class="fas fa-plus-circle me-2 text-success"></i>Thêm sản phẩm mới</h3>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    <label class="form-label fw-bold">
                                        <i class="fas fa-plus me-2"></i>Tên sản phẩm *
                                    </label>
                                ...
                                <div class="mb-4">
                                    <label class="form-label fw-bold">
                                        <i class="fas fa-align-left me-2"></i>Thêm mô tả
                                    </label>
                                    <textarea name="description" class="form-control" rows="4" 
                                              placeholder="Nhập mô tả sản phẩm..."><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
                                </div>
                            </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="image-preview" onclick="document.getElementById('imageInput').click()">
                                        <div id="imagePreview">
                                            ...
                                            <p class="text-muted mb-0">Click để chọn hình ảnh</p>
                        ...
                        <div class="text-center pt-3">
                            <button type="submit" class="btn btn-primary btn-lg px-5">
                                <i class="fas fa-save me-2"></i>Đồng ý
                            </button>
