    ...
    <header class="bg-light py-2 shadow-sm">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="search flex-grow-1 mx-4">
                <form method="POST" action="pages/user/search.php" class="d-flex">
            ...
            <div class="user-cart d-flex gap-3">
                <?php if (isset($_SESSION['id_nguoidung'])): ?>
                    ...
                    <a href="pages/user/logout.php" class="btn btn-outline-secondary">Đăng xuất</a>
                    <?php if ($_SESSION['vaitro'] == 'user'): ?>
                        <a href="pages/user/cart.php" class="btn btn-outline-success">🛒 Giỏ hàng</a>
                    <?php endif; ?>
                <?php else: ?>
                    <a href="pages/user/login.php" class="btn btn-outline-primary">Đăng nhập/Đăng ký</a>
                <?php endif; ?>
            </div>
        </div>
    </header>
                                    ...
                                    <div class="card h-100 text-center shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php if (isset($_SESSION['id_nguoidung']) && $_SESSION['vaitro'] == 'user'): ?>
                                                <form method='POST' action='pages/user/cart.php'>
